...
# ==========================================
    ...
    st.sidebar.markdown("<p style='color:#64748b; font-size:12px; margin-top:0;'>Otoritas Kasir: Active</p>", unsafe_allow_html=True)
    st.sidebar.markdown("---")
    ...
    if menu == "Beranda Utama":
        ...
        # Baris di bawah ini yang tadinya error sudah digabung rapi satu baris penuh:
